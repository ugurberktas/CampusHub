    ...
    <div className="min-h-screen flex font-sans">
      ...
      <div className="hidden md:flex w-1/2 bg-[#800000] flex-col justify-center items-center relative">
        <div className="text-center">
          ...
          <p className="text-white opacity-80 italic text-sm">Kampüs hayatının merkezi.</p>
        </div>
      ...
      <div className="w-full md:w-1/2 bg-white flex flex-col justify-center px-8 sm:px-10 h-screen relative">
        ...
        <div className="max-w-sm w-full mx-auto">
          ...
          <div className="mb-8 text-center md:text-left">
            <h1 className="text-2xl font-black text-[#111111] mb-1">Öğrenci Girişi</h1>
          ...
          {error && (
            <div className="mb-6 bg-red-50 border border-red-200 text-red-700 rounded-lg p-3 text-sm">
              {error === 'role_error' ? (
                <>
                  Bu giriş formu yalnızca öğrencilere özeldir.
                  Topluluk girişi için → <Link to="/topluluk-girisi" className="text-red-700 font-bold underline">Topluluk Girişi</Link>
                </>
              ) : (
                error
              )}
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            Hesabın yok mu?{' '}
            <Link to="/ogrenci-kayit" className="text-[#800000] font-medium hover:underline">
              Kayıt Ol
            </Link>
          </div>
        </div>
